...
export default function BookingPage() {
  return (
    <div className="pt-28 md:pt-32 pb-16 md:pb-20 px-4 md:px-6 max-w-7xl mx-auto min-h-screen carbon-pattern">
      {/* Title & Quick Actions */}
      <div className="mb-12 md:mb-16 flex flex-col md:flex-row md:items-end justify-between gap-8">
        <div>
          ...
          <h1 className="font-headline text-4xl md:text-5xl lg:text-7xl font-black text-white tracking-tighter leading-none">
            RESERVE YOUR <br />
        ...
        {/* Quick WhatsApp */}
        <div className="bg-surface-container border-l-4 border-primary p-4 md:p-6 flex items-center gap-4 md:gap-6 group hover:bg-surface-container-high transition-colors">
