...
const galleryItems = [
  ...
  {
    src: "/images/gallery-steering.jpg",
    alt: "Close up of a luxury car steering wheel",
    title: "",
    subtitle: "",
  ...
  {
    src: "/images/gallery-lambo.jpg",
    alt: "Lamborghini Aventador front view",
    title: "THE BULL OF DUBAI",
    subtitle: "Aventador SVJ Performance Kit",
    className: "masonry-item-wide",
  },
  {
    src: "/images/gallery-amg.jpg",
    alt: "Mercedes AMG engine details",
    title: "",
    subtitle: "",
    className: "masonry-item-square",
    hasButton: true,
  ...
  {
    src: "/images/gallery-supra.jpg",
    alt: "Custom white Supra drifting",
    title: "Supra MK5 Hybrid",
    subtitle: "Drift Spec",
    className: "masonry-item-tall",
    hasStats: true,
  },
  {
    ...
    alt: "Red Ferrari detail",
    title: "",
    subtitle: "",
    className: "masonry-item-square",
  },
  {
    src: "/images/gallery-exhaust.jpg",
    alt: "Performance car exhaust with flames",
    title: "",
    subtitle: "Live from Workshop",
    className: "masonry-item-wide",
    isLive: true,
  },
];
